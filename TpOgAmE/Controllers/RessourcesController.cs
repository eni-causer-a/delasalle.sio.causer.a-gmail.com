...
namespace TpOgAmE.Controllers
{
    public class RessourcesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,name,lastQuantity,lastUpdate")] Ressource ressource)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,name,lastQuantity,lastUpdate")] Ressource ressource)
        {
            if (ModelState.IsValid)
            {
